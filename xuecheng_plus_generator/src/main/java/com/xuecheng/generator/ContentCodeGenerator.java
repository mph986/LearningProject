...
public class ContentCodeGenerator {
    ...
    //数据库密码
    private static final String DATA_SOURCE_PASSWORD = "980606";
    //生成的表
...
//			"mq_message_history"
    ...
    public static void main(String[] args) {
        ...
        //生成路径
        gc.setOutputDir(System.getProperty("user.dir") + "/xuecheng_plus_generator/src/main/java");
        gc.setAuthor("mph");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://39.101.74.46:3306/xc_" + SERVICE_NAME
